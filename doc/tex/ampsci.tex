...
%======================================================
\subsection[Core polarisation (RPA)]{Core polarisation (RPA)\footnote{Method implemented in:~/src/HF/ExternalField.hpp}\label{sec:RPA}}
...
%======================================================
\subsection[Core polarisation (RPA diagram technique)]{Core polarisation (RPA diagram technique)\footnote{Method implemented in:~/src/MBPT/DiagramRPA.hpp}\label{sec:RPA-diagram}}
