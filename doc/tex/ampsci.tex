...
%
We define the reduced angular integral:
\begin{align}
...
The Coulomb integrals have angular decomposition:
\begin{align}
...
where $C^k_{abcd}$ depends on magnetic quantum numbers, and $Q$ is independent of magnetic quantum numbers.
Using the graphical formalism~\cite{Lindgren1986} (with Lindgren phase choice),
\begin{align}
C^k_{abcd} &= (-1)^{j_a+j_b+1} \,\,\eqdiagram{0.16}{img/angles/gabcd}.
%\\
