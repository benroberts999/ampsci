...
\def\updatedDate{24 August 2020}
...
More accurate approaches, known as multi-step methods, approximate the value of the derivative along the interval $(r, r+\delta r)$ with greater accuracy by using more previous points in the estimation. %(in essence, this approximates the higher-order derivatives).
%
