...
template <typename T> T JL(int L, T x) {
  ...
  if (fabs(x) < 0.1) {
    if (L == 0)
      return 1. - 0.166666667 * (x * x) + 0.00833333333 * pow(x, 4);
    if (L == 1)
      return 0.333333333 * x - 0.0333333333 * (x * x * x) +
             0.00119047619 * pow(x, 5);
    if (L == 2)
      return 0.0666666667 * (x * x) - 0.00476190476 * pow(x, 4) +
             0.000132275132 * pow(x, 6);
    if (L == 3)
      return 0.00952380952 * (x * x * x) - 0.000529100529 * pow(x, 5) +
             0.000012025012 * pow(x, 7);
    if (L == 4)
      return 0.00105820106 * pow(x, 4) - 0.0000481000481 * pow(x, 6) +
