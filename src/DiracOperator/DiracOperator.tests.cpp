...
TEST_CASE("DiracOperator", "[DiracOperator][unit]") {
  ...
  SECTION("Radial_int_rhs") {
    for (const auto &entry : DiracOperator::Registry::get().entries()) {
      std::cout << entry.name << "\n";
      const auto h = entry.factory({}, wf);
  ...
  SECTION("E2") {
    std::cout << "Ek\n";
    const auto data = std::vector{std::tuple{"1s+", "3d-", -1.5500083193e+00},
                                  {"2p-", "2p+", -2.6832065561e+01},
                                  {"2p+", "2p-", 2.6832065561e+01},
                                  {"2p+", "2p+", 2.6832553768e+01},
                                  {"3d-", "1s+", 1.5500083193e+00},
                                  {"3d-", "3d-", 1.1269636146e+02}};
  ...
  SECTION("M1") {
    ...
    const auto data = std::vector{std::tuple{"1s+", "1s+", 2.4494462627e+00},
                                  {"1s+", "3d-", -1.0524567977e-06},
                                  {"2p-", "2p-", 8.1648571086e-01},
                                  {"2p-", "2p+", 1.1546966950e+00},
                                  {"2p+", "2p-", -1.1546966950e+00},
                                  {"2p+", "2p+", 5.1639502960e+00},
                                  {"3d-", "1s+", 1.0524567977e-06},
                                  {"3d-", "3d-", 3.0983744552e+00}};
  ...
  SECTION("hfs") {
    ...
    std::cout << "hfs\n";
    const auto data0 = std::vector{std::tuple{"1s+", "1s+", 2.2989921442e+02},
                                   {"1s+", "3d-", 1.2365855847e+00},
                                   {"2p-", "2p-", 9.5793869104e+00},
                                   {"2p-", "2p+", -1.6932864896e+00},
                                   {"2p+", "2p-", 1.6932864896e+00},
                                   {"2p+", "2p+", 6.0579985410e+00},
                                   {"3d-", "1s+", -1.2365855847e+00},
                                   {"3d-", "3d-", 1.0769837845e+00}};

    const auto dataB = std::vector{std::tuple{"1s+", "1s+", 2.2985924215e+02},
                                   {"1s+", "3d-", 1.2365855696e+00},
                                   {"2p-", "2p-", 9.5793868013e+00},
                                   {"2p-", "2p+", -1.6932864687e+00},
                                   {"2p+", "2p-", 1.6932864687e+00},
                                   {"2p+", "2p+", 6.0579985410e+00},
                                   {"3d-", "1s+", -1.2365855696e+00},
                                   {"3d-", "3d-", 1.0769837845e+00}};

    const auto dataSP = std::vector{std::tuple{"1s+", "1s+", 2.2987811846e+02},
                                    {"1s+", "3d-", 1.2365855809e+00},
                                    {"2p-", "2p-", 9.5793868691e+00},
                                    {"2p-", "2p+", -1.6932864843e+00},
                                    {"2p+", "2p-", 1.6932864843e+00},
                                    {"2p+", "2p+", 6.0579985410e+00},
                                    {"3d-", "1s+", -1.2365855809e+00},
                                    {"3d-", "3d-", 1.0769837845e+00}};

    const auto dataBW_SP =
      std::vector{std::tuple{"1s+", "1s+", -9.1761780763e-05},
                  {"1s+", "3d-", -3.0882896817e-09},
                  {"2p-", "2p-", -4.3124463670e-09},
                  {"2p-", "2p+", -3.1269503625e-09},
                  {"2p+", "2p-", -3.1269504936e-09},
                  {"2p+", "2p+", -8.9433635935e-15},
                  {"3d-", "1s+", -3.0882895022e-09},
  ...
  SECTION("hfs(2)") {
    std::cout << "hfs(2)\n";
    const auto data = std::vector{std::tuple{"1s+", "3d-", -2.1316106122e+00},
                                  {"2p-", "2p+", -8.7571740477e+00},
                                  {"2p+", "2p-", 8.7571740477e+00},
                                  {"2p+", "2p+", 8.7568728690e+00},
                                  {"3d-", "1s+", 2.1316106122e+00},
                                  {"3d-", "3d-", 5.1893316865e-01}};
  ...
  SECTION("pnc") {
    std::cout << "pnc\n";
    const auto data = std::vector{std::tuple{"1s+", "2p-", -3.9534395445e-07},
                                  {"2p-", "1s+", 3.9534395445e-07},
                                  {"2p+", "3d-", -3.4613863483e-17},
                                  {"3d-", "2p+", 3.4613863483e-17}};
